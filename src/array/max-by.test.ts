...
Deno.test("maxBy", async t => {
  ...
  await t.step('should return the object with the maximum value for a specific key', () => {
  ...
  await t.step('should return the first object if there are multiple objects with the maximum value', () => {
    const result = maxBy([{ id: 1, value: 10 }, { id: 2, value: 10 }, { id: 3, value: 10 }], 'value')
