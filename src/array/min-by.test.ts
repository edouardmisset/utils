...
Deno.test("minBy", async t => {
  ...
  await t.step('should return the object with the minimum value for a specific key', () => {
  ...
  await t.step('should return the first object if there are multiple objects with the minimum value', () => {
    const result = minBy([{ id: 1, value: 10 }, { id: 2, value: 10 }, { id: 3, value: 10 }], 'value')
