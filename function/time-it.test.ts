...
Deno.test('timeIt - synchronous success', async () => {
...
Deno.test('timeIt - synchronous error', async () => {
  const time = new FakeTime()
  try {
    const result = await timeIt(() => {
...
Deno.test('timeIt - async function success (await)', async () => {
  const time = new FakeTime()
  try {
...
Deno.test('timeIt - promise-returning function success', async () => {
  const time = new FakeTime()
  try {
    const p = timeIt(() =>
...
Deno.test('timeIt - async error (rejection)', async () => {
  const time = new FakeTime()
  try {
    const p = timeIt(async () => {
