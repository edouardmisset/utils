...
Deno.test('validateNumber', async (t) => {
  ...
  await t.step(
    'validateNumber returns true for numeric strings representing finite numbers',
    () => {
      assertEquals(validateNumber('123'), true)
  ...
  await t.step(
    'validateNumber returns false for non-numeric strings and numeric strings representing non-finite numbers',
    () => {
